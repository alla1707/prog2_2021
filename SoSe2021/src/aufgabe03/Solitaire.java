...
public class Solitaire {
	...
	public void move(Move move) throws IllegalArgumentException
	{
		...
		{
			throw new IllegalArgumentException("Verschieben ist nicht möglich(" + move.getFrom().getRow() + ", " + move.getFrom().getCol() + ") --> "
	...
	{
		System.out.println("Machen Sie den ersten möglichen Schritt aus der folgenden Liste möglicher Schritte:");
	...
	public Moves getGame() {
		return game;
	}

	public void setGame(Moves game) {
		this.game = game;
	}
}
